...
structdef(hkArray_VkSurfaceFormatKHR) {
...
hkArray_VkSurfaceFormatKHR hkarray_VkSurfaceFormatKHR_create(size_t length) {
    hkArray_VkSurfaceFormatKHR array = {0};
    if (length == 0) {
        array.unit_size = sizeof(VkSurfaceFormatKHR);
        array.length = length;
        array.data = NULL;
        array.border = 0;
        return array;
...
void hkarray_VkSurfaceFormatKHR_destroy(hkArray_VkSurfaceFormatKHR *array) {
    array->border = 0;
    array->length = 0;
    array->unit_size = 0;
    free(array->data);
...
VkSurfaceFormatKHR *hkarray_VkSurfaceFormatKHR_resize(hkArray_VkSurfaceFormatKHR *array, size_t new_border) {
...
VkSurfaceFormatKHR *hkarray_VkSurfaceFormatKHR_append(hkArray_VkSurfaceFormatKHR *array, VkSurfaceFormatKHR elem) {
    if (array->length == 0 && array->border == 0) { 
        array->length += 1;
        array->border += 1;
        hkarray_VkSurfaceFormatKHR_resize(array, array->border);
...
int hkarray_VkSurfaceFormatKHR_is_empty(hkArray_VkSurfaceFormatKHR *array) {
