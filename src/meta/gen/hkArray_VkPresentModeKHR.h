...
structdef(hkArray_VkPresentModeKHR) {
...
hkArray_VkPresentModeKHR hkarray_VkPresentModeKHR_create(size_t length) {
    hkArray_VkPresentModeKHR array = {0};
    if (length == 0) {
        array.unit_size = sizeof(VkPresentModeKHR);
        array.length = length;
        array.data = NULL;
        array.border = 0;
        return array;
...
void hkarray_VkPresentModeKHR_destroy(hkArray_VkPresentModeKHR *array) {
    array->border = 0;
    array->length = 0;
    array->unit_size = 0;
    free(array->data);
...
VkPresentModeKHR *hkarray_VkPresentModeKHR_resize(hkArray_VkPresentModeKHR *array, size_t new_border) {
...
VkPresentModeKHR *hkarray_VkPresentModeKHR_append(hkArray_VkPresentModeKHR *array, VkPresentModeKHR elem) {
    if (array->length == 0 && array->border == 0) { 
        array->length += 1;
        array->border += 1;
        hkarray_VkPresentModeKHR_resize(array, array->border);
...
int hkarray_VkPresentModeKHR_is_empty(hkArray_VkPresentModeKHR *array) {
